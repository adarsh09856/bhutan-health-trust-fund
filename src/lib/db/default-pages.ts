...
export const defaultCorePages: DefaultPageDef[] = [
    ...
    sections: [
      {
        ...
        subtitle: "We welcome citizen inquiries, partnership dialogues, and donor consultations across all 20 Dzongkhags.",
  ...
  {
    slug: "news",
    title: "News, Press Bulletins & Field Dispatches | BHTF",
    metaDescription: "Official press releases, cold chain updates, and healthcare commodity dispatches from Bhutan Health Trust Fund.",
    isSystemPage: true,
    sections: [
      {
        id: "news-hero",
        ...
        order: 1,
        isVisible: true,
        title: "Official Press Releases & Field Dispatches",
        subtitle: "Verified dispatches, procurement communiqués, and cold chain milestones across Bhutan.",
        dzongkhaText: "གནས་ཚུལ་དང་ གསལ་བསྒྲགས།",
        badge: "Institutional Press Office",
        bgVariant: "dark",
      },
    ],
  },
  {
    slug: "track-donation",
    title: "Track Donation & DRC Tax Certificate | BHTF",
    metaDescription: "Verify your healthcare contribution, confirm 1:1 RGOB Royal Match, and generate your DRC tax certificate.",
    isSystemPage: true,
    sections: [
      {
        id: "track-hero",
        ...
        order: 1,
        isVisible: true,
        title: "Contribution Verification & Tax Vouchers",
        subtitle: "Audit your transaction reference, verify the 1:1 sovereign match, and download your sealed DRC 100% tax exemption certificate.",
        dzongkhaText: "ཞལ་འདེབས་བདེན་དཔྱད་དང་ ཁྲལ་ཡང་སྙན་ཞུ།",
        badge: "Department of Revenue & Customs Compliant",
        bgVariant: "dark",
      },
    ],
  },
