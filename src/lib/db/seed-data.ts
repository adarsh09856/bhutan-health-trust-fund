...
export const initialCourses = [
  {
    slug: "alpine-cold-chain-vaccine-logistics",
    title: "Alpine Cold Chain Logistics & Solar Refrigeration",
    category: "Cold Chain & Vaccines",
    description: "Master temperature-sensitive vaccine storage protocols, solar direct drive (SDD) maintenance, and high-altitude cold box portage in remote gewogs like Lunana, Laya, and Soe.",
    instructor: "National Cold Chain Team & WHO Faculty",
  ...
  {
    slug: "essential-medicines-formulary-2026",
    title: "National Essential Medicines Formulary & Dispensing Guidelines 2026",
    category: "Essential Medicines",
    description: "Comprehensive training on the National Essential Drugs List (NEDL), rational prescribing, antibiotic stewardship, and stockout buffer management in Basic Health Units (BHUs).",
    instructor: "DRA Bhutan & KGUMSB Clinical Pharmacy Faculty",
    durationHours: "6.0 Hours",
    difficulty: "Advanced",
    modulesCount: 5,
    enrolledCount: 215,
    isPublished: true,
  ...
  {
    slug: "who-prequalification-vaccine-safety",
    title: "WHO Prequalification & Routine Vaccine Safety Surveillance",
    category: "Quality Assurance",
    description: "International standards for vaccine quality assurance, Adverse Events Following Immunization (AEFI) reporting protocols, and batch testing compliance.",
    instructor: "Department of Public Health & WHO Bhutan",
  ...
  {
    slug: "safe-motherhood-emergency-delivery-kits",
    title: "Safe Motherhood & Emergency Neonatal Delivery Packs",
    category: "Maternal Health",
    description: "Deployment, sterile handling, and emergency clinical utilization of clean delivery kits and neonatal resuscitation equipment in remote health outposts.",
    instructor: "JDWNRH Obstetric Specialists & BHTF Medical Officers",
...
export const initialEnrollments = [
  {
    courseId: 1,
    studentName: "Kinley Wangdi",
    studentEmail: "kinley.w@health.gov.bt",
    progressPercent: 100,
    quizScore: 95,
    isCompleted: true,
    certificateId: "BHTF-CERT-2026-8812",
  },
  {
    courseId: 2,
    studentName: "Dawa Pem",
    studentEmail: "dawa.pem@kgumsb.edu.bt",
    progressPercent: 100,
    quizScore: 90,
    isCompleted: true,
    certificateId: "BHTF-CERT-2026-8813",
  },
];
