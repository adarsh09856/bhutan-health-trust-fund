...
export const initialTrustees: NewTrustee[] = [
  {
    ...
    badge: "Trustee",
    bio: "Oversees multilateral partnerships, international sovereign agreements, and bilateral healthcare endowments.",
    photoUrl: "/src/assets/reference/trustee_lesang_wangdi.webp",
    orderIndex: 1,
    isActive: true,
  },
  {
    ...
    organization: "Board of Trustees, BHTF",
    badge: "Trustee",
    bio: "Directs epidemiological research, evidence-based health investment allocations, and climate health resilience.",
    photoUrl: "/src/assets/reference/trustee_nawang_norbu.webp",
    orderIndex: 2,
    isActive: true,
  },
  {
    ...
    bio: "Oversees 1:1 RGOB matching fund allocations, capital ring-fencing, and statutory investment policy compliance.",
    photoUrl: "/src/assets/reference/trustee_sonam_tashi.webp",
    orderIndex: 3,
    isActive: true,
  },
  {
    ...
    organization: "Board of Trustees, BHTF",
    badge: "Audit & Risk",
    bio: "Advises on asset management, external statutory auditing, and strict Royal Audit Authority conformance.",
    photoUrl: "/src/assets/reference/trustee_tshering_dorji.webp",
    orderIndex: 4,
    isActive: true,
  },
  {
    ...
    organization: "Board of Trustees, BHTF",
    badge: "Governance",
    bio: "Specializes in trust governance, Royal Charter compliance, and institutional statutory policies.",
    photoUrl: "/src/assets/reference/trustee_tshering_yangzom.webp",
    orderIndex: 5,
    isActive: true,
  },
  {
    ...
    bio: "Represents corporate stakeholders, private contributions, and community philanthropy stewardship.",
    photoUrl: "/src/assets/reference/trustee_sonam_leki_dorji.webp",
    orderIndex: 6,
    isActive: true,
  },
  {
    ...
    bio: "Leads day-to-day capital endowment management, international tender financing, and nationwide commodity supply buffers.",
    photoUrl: "/src/assets/reference/director_karma_tshering.webp",
    orderIndex: 7,
    isActive: true,
  },
  {
    ...
    organization: "Board of Trustees, BHTF",
    badge: "Innovation",
    bio: "Advises on digital health logistics, high-altitude solar cold chain automation, and supply chain telemetry.",
    photoUrl: "/src/assets/reference/trustee_ujjwal_deep_dahal.webp",
    orderIndex: 8,
    isActive: true,
  },
];
